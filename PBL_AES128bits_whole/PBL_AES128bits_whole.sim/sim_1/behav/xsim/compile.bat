...
REM
REM Generated by Vivado on Wed Apr 22 16:24:29 +0530 2026
...
echo "xvlog --incr --relax -prj aes_top_tb_vlog.prj"
call xvlog  --incr --relax -prj aes_top_tb_vlog.prj -log xvlog.log
